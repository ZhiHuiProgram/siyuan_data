...
#endif
	extern int do_auto_update(cmd_tbl_t *cmdtp, int flag, int argc, char * const argv[]);
	puts("Auto-update: ");
	do_auto_update(NULL,NULL,1,NULL);
